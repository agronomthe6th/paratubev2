...
function VideoWatchItemCard3(video) {
    ...
    return (
      <Card
        onMouseEnter={() => setth(video.video.preview)}
        onMouseLeave={() => setth(video.video.thumbnail)}
        id = 'box-card'
        sx={{
          // mb: 2,
          minWidth: 300,
...
export default VideoWatchItemCard3
